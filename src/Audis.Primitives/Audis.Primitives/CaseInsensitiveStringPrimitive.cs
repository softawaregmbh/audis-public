    ...
    : Primitive<string>
{
    public CaseInsensitiveStringPrimitive(string value)
        : base(value)
    {
        if (string.IsNullOrWhiteSpace(value)) throw new ArgumentNullException("Value must not be null or whitespace.");
    }

    public virtual bool Equals(CaseInsensitiveStringPrimitive? other)
    {
